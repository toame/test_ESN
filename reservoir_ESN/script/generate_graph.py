...
parser.add_argument('--taskes',default=["approx_3_0.0", "approx_6_-0.5", "approx_11_-1.0", "narma_5", "narma_10", "henon_3", "laser1_2", "count_4", "count_5", "laser0_2", "laser0_3", "laser1_3", "laser2_2", "laser2_3", "henon_4"], nargs='*')
